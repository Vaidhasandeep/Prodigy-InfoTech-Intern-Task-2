...
df1 = pd.read_csv('C:\\Users\\v.omsai\\Downloads\\test.csv')
df1.head()
...
df1.drop(columns=['PassengerId','Ticket','Name','Cabin'],inplace=True)
...
from scipy.stats import boxcox
df1['Fare'],a =boxcox(abs(df1['Fare']+0.00001)) 
...
test_data = model_gbc.predict(df1)
